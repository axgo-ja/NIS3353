...
# === SLIDE 3: WaNet ===
s=prs.slides.add_slide(prs.slide_layouts[6]); bg(s)
tb(s,Inches(0.8),Inches(0.5),Inches(7),Inches(0.5),"WaNet: 基于图像形变的后门攻击 (ICLR 2021)",30,TXT,True)
line(s,Inches(0.8),Inches(1.1),Inches(1.5))
mtb(s,Inches(0.8),Inches(1.5),Inches(5.8),Inches(3.0),[
    ("核心思想:",True,ROSE),
...
mtb(s,Inches(0.8),Inches(1.6),Inches(5.5),Inches(3.0),[
    ...
    ("Warping = grid_sample + bilinear interpolation",True,ROSE),
    ("",False,MUTED),
    ("插值运算 = 信号处理 -> 必然在频域留下痕迹!",True,TXT),
    ("",False,MUTED),
    ("全新检测思路:",False,MUTED),
...
tb(s,Inches(0.8),Inches(5.8),Inches(11.7),Inches(0.5),"这是论文从未探讨过的维度: 不可感知 != 不可检测",18,ROSE,True,PP_ALIGN.CENTER)
