...
def get_argument():
    ...
    parser.add_argument("--result", type=str, default=os.path.join(REPO_ROOT, "defenses", "neural_cleanse", "results"))
    parser.add_argument("--dataset", type=str, default="mnist")
    parser.add_argument("--attack_mode", type=str, default="all2one")
    parser.add_argument("--temps", type=str, default=os.path.join(REPO_ROOT, "defenses", "neural_cleanse", "temps"))
